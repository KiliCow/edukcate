...
@section('content')
<edukcate-register-stripe inline-template>
    <div>
        <div class="edukcate-screen container">
            <!-- Common Register Form Contents -->
            @include('edukcate::auth.register-common')
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            ...
                            <form role="form">
                                ...
                                @if (Edukcate::collectsBillingAddress())
                                    @include('edukcate::auth.register-address')
                                @endif

                                <!-- ZIP Code -->
                                <div class="form-group row" v-if=" ! edukcate.collectsBillingAddress">
                                ...
                                <div class="form-group row" v-if="edukcate.collectsEuropeanVat && countryCollectsVat && selectedPlan">
                                    ...
                                    <div class="col-md-6">
                                        <div class="alert alert-info" style="margin: 0;">
                                            ...
                                            @{{ selectedPlan.type == 'user' && edukcate.chargesUsersPerSeat ? '/ '+ edukcate.seatName : '' }}
                                            @{{ selectedPlan.type == 'user' && edukcate.chargesUsersPerTeam ? '/ '+ __('teams.team') : '' }}
                                            @{{ selectedPlan.type == 'team' && edukcate.chargesTeamsPerSeat ? '/ '+ edukcate.teamSeatName : '' }}
                                            @{{ selectedPlan.type == 'team' && edukcate.chargesTeamsPerMember ? '/ '+ __('teams.member') : '' }}
