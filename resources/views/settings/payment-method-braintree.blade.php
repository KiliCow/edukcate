<edukcate-payment-method-braintree :user="user" :team="team" :billable-type="billableType" inline-template>
    <div>
        <!-- Current Discount -->
        ...
        <!-- Update Card -->
        @include('edukcate::settings.payment-method.update-payment-method-braintree')
...
</edukcate-payment-method-braintree>
