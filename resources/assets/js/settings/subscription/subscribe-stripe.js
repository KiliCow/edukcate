module.exports = {
    ...
    methods: {
        ...
        /*
         * After obtaining the Stripe token, create subscription on the Edukcate server.
         */
        createSubscription(token) {
            this.form.stripe_token = token;

            Edukcate.post(this.urlForNewSubscription, this.form)
                .then(response => {
                    Bus.$emit('updateUser');
                    Bus.$emit('updateTeam');
                });
    ...
    computed: {
        ...
        urlForNewSubscription() {
            return this.billingUser
                            ...
                            : `/settings/${Edukcate.teamsPrefix}/${this.team.id}/subscription`;
        },
