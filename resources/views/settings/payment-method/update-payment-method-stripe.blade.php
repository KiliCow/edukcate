<edukcate-update-payment-method-stripe :user="user" :team="team" :billable-type="billableType" inline-template>
        ...
        <div class="card-body">
            ...
            <form role="form">
                ...
                @if (Edukcate::collectsBillingAddress())
                    @include('edukcate::settings.payment-method.update-payment-method-address')
                @endif
...
</edukcate-update-payment-method-stripe>
