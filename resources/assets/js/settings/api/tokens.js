module.exports = {
    ...
    data() {
        return {
            ...
            updateTokenForm: new EdukcateForm({
                name: '',
                abilities: []
            }),

            deleteTokenForm: new EdukcateForm({})
        }
    },
    ...
    methods: {
         ...
         */
        updateToken() {
            Edukcate.put(`/settings/api/token/${this.updatingToken.id}`, this.updateTokenForm)
                .then(response => {
         ...
         */
        deleteToken() {
            Edukcate.delete(`/settings/api/token/${this.deletingToken.id}`, this.deleteTokenForm)
                .then(() => {
                    this.$parent.$emit('updateTokens');
