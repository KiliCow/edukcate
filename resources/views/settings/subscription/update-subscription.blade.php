<edukcate-update-subscription :user="user" :team="team"
    ...
    <div>
        <div class="card card-default">
            ...
            <div class="table-responsive">
                ...
                <!-- European VAT Notice -->
                @if (Edukcate::collectsEuropeanVat())
                    <p class="m-4">
                            ...
                            <td>
                                <div class="btn-table-align">
                                    ...
                                    <span v-else>
                                        ...
                                        @{{ plan.type == 'user' && edukcate.chargesUsersPerSeat ? '/ '+ edukcate.seatName : '' }}
                                        @{{ plan.type == 'user' && edukcate.chargesUsersPerTeam ? '/ '+ __('teams.team') : '' }}
                                        @{{ plan.type == 'team' && edukcate.chargesTeamsPerSeat ? '/ '+ edukcate.teamSeatName : '' }}
                                        @{{ plan.type == 'team' && edukcate.chargesTeamsPerMember ? '/ '+ __('teams.member') : '' }}
