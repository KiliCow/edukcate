module.exports = {
    ...
    methods: {
        ...
        getUserProfile(id) {
            ...
            axios.get('/edukcate/kiosk/users/' + id + '/profile')
                .then(response => {
         ...
         */
        impersonate(user) {
            window.location = '/edukcate/kiosk/users/impersonate/' + user.id;
        },
