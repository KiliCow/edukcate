module.exports = {
    ...
    methods: {
         ...
         */
        getRevenue() {
            axios.get('/edukcate/kiosk/performance-indicators/revenue')
                .then(response => {
         ...
         */
        getPlans() {
            axios.get('/edukcate/kiosk/performance-indicators/plans')
                .then(response => {
         ...
         */
        getTrialUsers() {
            axios.get('/edukcate/kiosk/performance-indicators/trialing')
                .then(response => {
        ...
        getPerformanceIndicators() {
            axios.get('/edukcate/kiosk/performance-indicators')
                .then(response => {
