/*
 * Load various JavaScript modules that assist Edukcate.
 */
...
window.__ = (key, replace) => {
    var translation = Edukcate.translations[key] ? Edukcate.translations[key] : key;
...
window.axios.defaults.headers.common = {
    ...
    'X-CSRF-TOKEN': Edukcate.csrfToken
};
