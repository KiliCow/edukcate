module.exports = {
    ...
    data() {
        return {
            ...
            registerForm: $.extend(true, new EdukcateForm({
                stripe_token: '',
                plan: '',
                team: '',
                team_slug: '',
                ...
                coupon: null,
                invitation: null
            }), Edukcate.forms.register),

            cardForm: new EdukcateForm({
                name: '',
                number: '',
                cvc: '',
                month: '',
    ...
    methods: {
        ...
        register() {
            ...
            if ( ! Edukcate.cardUpFront || this.selectedPlan.price == 0) {
        ...
        /*
         * After obtaining the Stripe token, send the registration to Edukcate.
         */
        sendRegistration() {
            Edukcate.post('/register', this.registerForm)
                .then(response => {
