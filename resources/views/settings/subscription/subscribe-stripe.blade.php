<edukcate-subscribe-stripe :user="user" :team="team"
                        :plans="plans" :billable-type="billableType" inline-template>

    <div>
        <!-- Common Subscribe Form Contents -->
    @include('edukcate::settings.subscription.subscribe-common')
            ...
            <div class="card-body">
                ...
                <form role="form">
                    ...
                    @if (Edukcate::collectsBillingAddress())
                        @include('edukcate::settings.subscription.subscribe-address')
                    @endif
