<edukcate-current-teams :user="user" :teams="teams" inline-template>
    <div>
                ...
                <table class="table table-valign-middle mb-0">
                    ...
                    <tbody>
                        <tr  v-for="team in teams">
                            <!-- Photo -->
                            <td>
                                <img :src="team.photo_url" class="edukcate-profile-photo">
                            </td>
                            ...
                            <!-- Edit Button -->
                            <td class="td-fit">
                                <a :href="'/settings/{{Edukcate::teamsPrefix()}}/'+team.id">
