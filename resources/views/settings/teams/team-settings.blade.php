...
@section('content')
<edukcate-team-settings :user="user" :team-id="{{ $team->id }}" inline-template>
        ...
        <div class="row">
            ...
            <div class="col-md-3 edukcate-settings-tabs">
                  ...
                  18c2.7737 0 5.2177-1.4116 6.6528-3.5556C14.6268 13.517 12.3738 13 10 13s-4.627.517-6.6528 1.4444z "></path>
                        ...
                        <li class="nav-item ">
                            ...
                            @if (Edukcate::createsAdditionalTeams())
                                <li class="nav-item ">
                                    <a class="nav-link" href="/settings#/{{str_plural(Edukcate::teamsPrefix())}}">
                                        <svg class="icon-20 " viewBox="0 0 20 20 " xmlns="http://www.w3.org/2000/svg ">
              ...
              0-1.2-.2.8-1 1.3-2.4 1.3-3.8s0-2.7-1-3.8l1-.2z " />
                ...
                @if (Edukcate::canBillTeams() && Auth::user()->ownsTeam($team))
                    <aside>
                        <h3 class="nav-heading ">
                            {{__('teams.team_billing')}}
                        </h3>
                        <ul class="nav flex-column mb-4 ">
                            @if (Edukcate::hasPaidTeamPlans())
                                <li class="nav-item ">
                ...
                <div class="tab-content">
                    ...
                    @if (Auth::user()->ownsTeam($team))
                        <div role="tabcard" class="tab-pane active" id="owner">
                            @include('edukcate::settings.teams.team-profile')
                        </div>
                    @endif
                    ...
                    @endif
                        <div v-if="team">
                            @include('edukcate::settings.teams.team-membership')
                        </div>
                    </div>
