<edukcate-kiosk-profile :user="user" :plans="plans" inline-template>
    <div>
        <!-- Loading Indicator -->
        ...
        <div v-if=" ! loading && profile">
                ...
                <div class="col-md-12">
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3 text-center">
                                    <img :src="profile.photo_url" class="edukcate-profile-photo-xl">
                                </div>
                                ...
                                <div class="col-md-9">
                                    ...
                                    <!-- Total Revenue -->
                                    <p>
                                        <strong>{{__('Total Revenue')}}:</strong> @{{ revenue | currency(edukcate.currencySymbol) }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-footer card-flush text-right">
                            <button class="btn btn-primary btn-sm" v-if="edukcate.usesStripe && profile.stripe_id" @click="addDiscount(profile)">
                                {{__('Apply Discount')}}
                            </button>
            ...
            <!-- Teams -->
            <div class="row" v-if="edukcate.usesTeams && profile.owned_teams.length > 0">
                <div class="col-md-12">
                    <div class="card card-default">
                        <div class="card-header">
                            {{__('teams.teams')}}
                            ...
                            <table class="table table-borderless m-b-none">
                                ...
                                <tbody>
                                    <tr v-for="team in profile.owned_teams">
                                        <!-- Photo -->
                                        <td>
                                            <img :src="team.photo_url" class="edukcate-team-photo">
                                        </td>
        ...
        <div>
            @include('edukcate::kiosk.modals.add-discount')
        </div>
    </div>
</edukcate-kiosk-profile>
