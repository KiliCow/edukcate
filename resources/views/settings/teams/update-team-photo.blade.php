<edukcate-update-team-photo :user="user" :team="team" inline-template>
            ...
            <form role="form">
                <div class="form-group row justify-content-center">
                    <div class="col-md-6 d-flex align-items-center">
                        ...
                        <div class="edukcate-uploader mr-4">
                            <input ref="photo" type="file" class="edukcate-uploader-control" name="photo" @change="update" :disabled="form.busy">
