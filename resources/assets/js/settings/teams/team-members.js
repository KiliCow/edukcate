module.exports = {
    ...
    data() {
        return {
            ...
            updateTeamMemberForm: $.extend(true, new EdukcateForm({
                role: ''
            }), Edukcate.forms.updateTeamMember),

            deleteTeamMemberForm: new EdukcateForm({})
        }
    },
    ...
    computed: {
        ...
        urlForUpdating: function () {
            return `/settings/${Edukcate.teamsPrefix}/${this.team.id}/members/${this.updatingTeamMember.id}`;
        },
         ...
         */
        urlForDeleting() {
            return `/settings/${Edukcate.teamsPrefix}/${this.team.id}/members/${this.deletingTeamMember.id}`;
        },
    },
    ...
    methods: {
         ...
         */
        getRoles() {
            axios.get(`/settings/${Edukcate.teamsPrefix}/roles`)
                .then(response => {
         ...
         */
        update() {
            Edukcate.put(this.urlForUpdating, this.updateTeamMemberForm)
                .then(() => {
                    Bus.$emit('updateTeam');
         ...
         */
        deleteMember() {
            Edukcate.delete(this.urlForDeleting, this.deleteTeamMemberForm)
                .then(() => {
                    Bus.$emit('updateTeam');
