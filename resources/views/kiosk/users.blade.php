<edukcate-kiosk-users :user="user" inline-template>
    <div>
                    ...
                    <table class="table table-valign-middle mb-0">
                        ...
                        <tbody>
                            <tr v-for="searchUser in searchResults">
                                <!-- Profile Photo -->
                                <td>
                                    <img :src="searchUser.photo_url" class="edukcate-profile-photo">
                                </td>
        ...
        <!-- User Profile Detail -->
        <div v-show="showingUserProfile">
            @include('edukcate::kiosk.profile')
        </div>
    </div>
</edukcate-kiosk-users>
