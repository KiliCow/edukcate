...
module.exports = {
    ...
    data() {
        return {
            ...
            form: new EdukcateForm(kioskAddDiscountForm())
        };
    },
    ...
    created() {
        ...
        Bus.$on('addDiscount', function (user) {
            self.form = new EdukcateForm(kioskAddDiscountForm());
    ...
    methods: {
         ...
         */
        applyDiscount() {
            Edukcate.post('/edukcate/kiosk/users/discount/' + this.discountingUser.id, this.form)
                .then(() => {
